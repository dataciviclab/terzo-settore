...
-- Consuma clean_input (fatti_ets long: cf, fonte, anno, importo) + RUNTS + geografia.
...
fatti_pivot AS (
    SELECT cf,
        ...
        -- Appalti pubblici ANAC (aggregati)
        ...
        SUM(CASE WHEN fonte = 'anac_partecipazione' THEN importo END) as gare_partecipate,

        -- Subappalti
        COUNT(CASE WHEN fonte = 'anac_subappalto' THEN 1 END) as subappalti,
